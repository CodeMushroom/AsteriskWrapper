...
namespace AsteriskWrapper
{
    public interface IChannels
    {
        ...
        Task<string> CreateChannel(string endpoint, string extension, string context, string priority, string app, CallerId callerId);
        Task<string> CreateChannel(string endpoint, string extension, string context, string priority, string app, CallerId callerId, CancellationToken cancellationToken);
    }
}
